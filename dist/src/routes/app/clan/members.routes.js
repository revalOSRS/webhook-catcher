...
router.get('/', async (req, res) => {
    try {
        ...
        if (search) {
            ...
            filteredMembers = womMembers.filter((wm) => wm.player.username.toLowerCase().includes(searchLower) ||
        ...
        const womIds = paginatedMembers.map((wm) => wm.player.id);
      ...
      `, [womIds]);
        ...
        // Combine data
        const enrichedMembers = paginatedMembers.map((wm) => {
