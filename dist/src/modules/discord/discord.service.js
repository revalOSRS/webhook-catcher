...
export class DiscordService {
     ...
     */
    static async getDiscordAvatar(discordId) {
        try {
     ...
     */
    static async getDiscordAvatars(discordIds) {
        const results = await Promise.allSettled(discordIds.map(async (id) => ({ id, avatar: await this.getDiscordAvatar(id) })));
     ...
     */
    static getDefaultDiscordAvatar(discordId) {
