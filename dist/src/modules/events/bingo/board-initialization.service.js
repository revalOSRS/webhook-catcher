 ...
 */
export async function initializeBoardsForEvent(eventId) {
    ...
    console.log(`[BoardInitialization] Teams query returned ${teams.length} teams:`, JSON.stringify(teams.map((t) => ({ id: t.id, name: t.name }))));
    if (teams.length === 0) {
 ...
 */
async function createBoardForTeam(eventId, teamId, teamName, genericBoard) {
