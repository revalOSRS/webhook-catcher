 ...
 */
async function fetchXpFromWiseOldMan(playerName, skill) {
    try {
 ...
 */
async function fetchHistoricalXpFromWiseOldMan(playerName, skill, date) {
    try {
 ...
 */
function mapSkillNameToWOMKey(skillName) {
    const skillMap = {
        'attack': 'attack',
        'strength': 'strength',
        'defence': 'defence',
