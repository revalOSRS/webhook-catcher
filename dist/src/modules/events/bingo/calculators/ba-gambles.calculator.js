 ...
 */
export const calculateBaGamblesProgress = (event, requirement, existing, memberId, osrsAccountId, playerName) => {
    ...
    const currentTotal = playerContributions.reduce((sum, p) => sum + p.gambleContribution, 0);
