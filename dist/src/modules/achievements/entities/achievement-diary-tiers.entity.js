 ...
 */
export class AchievementDiaryTiersEntity extends BaseEntity {
    tableName = 'achievement_diary_tiers';
    primaryKey = 'id';
    camelCaseFields = ['diaryName', 'totalTasks', 'createdAt'];
    /**
     ...
     */
    async findByNameAndTier(diaryName, tier) {
        return this.findOne({
     ...
     */
    async findByDiaryName(diaryName) {
        return this.findAll({
