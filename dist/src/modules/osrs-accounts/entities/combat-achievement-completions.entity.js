 ...
 */
export class CombatAchievementCompletionsEntity extends BaseEntity {
    tableName = 'osrs_account_combat_achievements';
    primaryKey = 'id';
    camelCaseFields = ['osrsAccountId', 'combatAchievementId', 'completedAt'];
    /**
     ...
     */
    async getCompletionsWithDetails(accountId) {
        const sql = `
      SELECT
        cac.*,
     ...
     */
    async hasCompleted(accountId, achievementId) {
