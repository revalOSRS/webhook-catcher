 ...
 */
export class AchievementDiaryCompletionsEntity extends BaseEntity {
    tableName = 'osrs_account_diary_completions';
    primaryKey = 'id';
    camelCaseFields = ['osrsAccountId', 'diaryTierId', 'completedAt'];
    /**
     ...
     */
    async hasCompleted(accountId, diaryTierId) {
