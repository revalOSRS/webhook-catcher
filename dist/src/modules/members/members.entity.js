...
export class MembersEntity extends BaseEntity {
    tableName = 'members';
    primaryKey = 'id';
    camelCaseFields = ['discordId', 'discordTag', 'memberCode', 'tokenBalance', 'isActive', 'inDiscord', 'createdAt', 'updatedAt', 'lastSeen'];
    /**
    ...
    async updateLastSeen(discordId) {
        const result = await this.executeQuery('UPDATE members SET last_seen = CURRENT_TIMESTAMP WHERE discord_id = $1', [discordId]);
