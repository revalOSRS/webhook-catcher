...
export const createDeathEmbed = async (fields, imageBuffer, imageFilename) => {
    const { playerName, accountType, dinkAccountHash, clanName, seasonalWorld, world, regionId, extra: { valueLost, isPvp, killerName, killerNpcId, keptItems, lostItems, location: { locationRegionId, locationPlane, locationInstanced } }, discordUser, embeds } = fields;
