...
export const createGrandExchangeEmbed = async (fields, imageBuffer, imageFilename) => {
    const { playerName, accountType, dinkAccountHash, clanName, seasonalWorld, world, regionId, extra: { slot, status, item: { id, quantity, priceEach, name }, marketPrice, targetPrice, targetQuantity, }, discordUser, embeds } = fields;
