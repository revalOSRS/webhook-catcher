 ...
 */
export class CofferBalanceEntity extends BaseEntity {
    tableName = 'coffer_balance';
    primaryKey = 'id';
    camelCaseFields = ['lastUpdated', 'updatedBy'];
    /**
     ...
     */
    static async updateBalance(newBalance, updatedBy = 'system') {
     ...
     */
    static async addToBalance(amount, updatedBy = 'system') {
        const currentBalance = await this.getCurrentBalance();
     ...
     */
    static async subtractFromBalance(amount, updatedBy = 'system') {
        const currentBalance = await this.getCurrentBalance();
        const newBalance = currentBalance - amount;
        await query(`
      UPDATE coffer_balance
