...
/**
 * GET /api/bingo/tiles/library/:id
...
/**
 * POST /api/bingo/tiles/library/bulk
...
/**
 * PATCH /api/bingo/tiles/library/:id
...
/**
 * DELETE /api/bingo/tiles/library/:id
...
router.delete('/:id', async (req: Request, res: Response) => {
	try {
		...
		const usage = await query(
			'SELECT COUNT(*) as count FROM bingo_board_tiles WHERE tile_id = $1',
			[id]
		);
...
/**
 * GET /api/bingo/tiles/library/categories/list
