 ...
 */
export const calculatePetProgress = (
  ...
  const existingMetadata = existing?.progressMetadata as PetProgressMetadata | undefined;
  
  // Get or initialize player contributions
  const playerContributions: PetPlayerContribution[] = 
  ...
  const progressMetadata: PetProgressMetadata = {
