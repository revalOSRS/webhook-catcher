 ...
 */
export async function adaptDinkEvent(dinkEvent: DinkEvent): Promise<UnifiedGameEvent | null> {
...
function adaptLootEvent(event: DinkLootEvent, osrsAccountId: number | undefined, timestamp: Date): UnifiedGameEvent {
...
function adaptPetEvent(event: DinkPetEvent, osrsAccountId: number | undefined, timestamp: Date): UnifiedGameEvent {
  return {
    eventType: 'PET',
    playerName: event.playerName,
    osrsAccountId,
...
function adaptSpeedrunEvent(event: DinkSpeedrunEvent, osrsAccountId: number | undefined, timestamp: Date): UnifiedGameEvent {
...
function adaptBaGambleEvent(event: DinkBarbarianAssaultGambleEvent, osrsAccountId: number | undefined, timestamp: Date): UnifiedGameEvent {
  return {
    eventType: 'BA_GAMBLE',
    playerName: event.playerName,
    osrsAccountId,
